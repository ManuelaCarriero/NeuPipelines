...
for i = 1:1:n_subjs %lst
    ...
    if strcmp(micro_parameter,'fsup')
        load('/media/nas_rete/Work_manuela/DWI_En_modeling_results/250611/V_fsup_tots.mat');
...
if strcmp(energy_parameter,'CBF')
    low_thr=0;% remove zeros outside brain image
